...
const MenuManagement: React.FC<MenuManagementProps> = ({ onBack }) => {
    ...
    const menuPopularity: MenuPopularity[] = useMemo(() => {
        ...
        // Analyze menu history (sample data)
        const sampleHistory = [
            { menuName: 'チキンカレー', rating: 4, date: '2024-01-15' },
            { menuName: '焼き魚定食', rating: 5, date: '2024-01-16' },
            { menuName: 'ハンバーグ', rating: 3, date: '2024-01-17' },
        ];

        sampleHistory.forEach((record: any) => {
    ...
    const ratingDistribution = useMemo(() => {
        ...
        const sampleRatings = [4, 5, 3, 4, 5, 3, 4, 2, 5, 4];
